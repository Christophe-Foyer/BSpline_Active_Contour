...
Description:
    This file introduces a solver class for fitting surfaces using a force
    analog model.
    
    Note: This is an unfinished work and has been left in its final state
    prior to submission.
"""
